       ...
       <a class="btn btn-sm btn-default btn-flat" href="<?php echo base_url(); ?>pegawai"><i class="fa fa-angle-left"></i> Back</a>
        ...
        <a class="btn btn-sm btn-warning btn-flat" href="<?php echo base_url();?>pegawai/penghargaan/<?php echo $pegawai->id_pegawai; ?>">Penghargaan</a>
        ...
        <tr>
          ...
          <?php echo $this->session->flashdata('message');?>
           <a class="btn btn-primary btn-flat btn-sm pull-right"  data-toggle="modal" data-target="#modal_tambah"><i class="fa fa-plus"></i> Tambah Riwayat Penghargaan</a><br><br><br>
...
<div class="box box-info">
  ...
  <tr>
    ...
    <th style="text-align:center">SK Penghargaan</th>
    <th style="text-align:center">Tanggal SK Penghagaan</th>
  ...
  <tbody>
    <?php 
      ...
      <td><?php echo ++$no;?></td>
        ...
        <td><?php echo $data->keterangan_penghargaan;?></td>
        <td><?php echo $data->no_sk_penghargaan;?></td>
        <td><?php if ($data->tgl_sk_penghargaan == '0000-00-00') {
          $a = ''; } else {
            $a = date("d M Y", strtotime($data->tgl_sk_penghargaan));
          }
         echo $a;?></td>
        <td>
        <a href="<?php echo base_url(); ?>pegawai/hapus_seminar/<?php echo $data->id_penghargaan; ?>/<?php echo $pegawai->id_pegawai; ?>" class="btn btn-danger btn-xs btn-flat" onclick="return confirm(<?php echo $alert; ?>)"><i class="glyphicon glyphicon-trash"></i><span class="tooltiptext">Hapus</span></a>
      </td>
    </tr>
<?php endforeach; ?>
           ...
           <div class="modal fade" id="modal_tambah" >
            ...
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="myModalLabel">Tambah Riwayat Penghargaan</h3>
            </div>
            <?php echo form_open('pegawai/simpan_penghargaan/'.$pegawai->id_pegawai); ?>
            <div class="form-horizontal">
                <div class="modal-body">

                    <div class="form-group">
                        <label class="col-xs-4" >Nama Penghargaan<font color="#FF0000">*</font></label>
                        <div class="col-xs-6">
                            <input type="text" name="nama_penghargaan" class="form-control input-sm pull-left" id="nama_penghargaan" value="" required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-4" >Keterangan </label>
                        <div class="col-xs-6">
                            <input type="text" name="keterangan_penghargaan" class="form-control input-sm pull-left" id="keterangan_penghargaan" placeholder="" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-4" >No. SK Penghargaan </label>
                        <div class="col-xs-6">
                            <input type="text" name="no_sk_penghargaan" class="form-control input-sm pull-left" id="no_sk_penghargaan" placeholder="" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-4" >Tanggal SK Penghargaan</label>
                        <div class="col-xs-6">
                            <input type="date" name="tgl_sk_penghargaan" class="form-control input-sm pull-left" id="tgl_sk_penghargaan" placeholder="" value="">
                        </div>
                    </div>
