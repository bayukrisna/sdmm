       ...
       <a class="btn btn-sm btn-default btn-flat" href="<?php echo base_url(); ?>pegawai"><i class="fa fa-angle-left"></i> Back</a>
        ...
        <a class="btn btn-sm btn-warning btn-flat" href="<?php echo base_url();?>pegawai/pelatihan/<?php echo $pegawai->id_pegawai; ?>">Pelatihan</a>
        ...
        <tr>
          ...
          <?php echo $this->session->flashdata('message');?>
           <a class="btn btn-primary btn-flat btn-sm pull-right"  data-toggle="modal" data-target="#modal_tambah"><i class="fa fa-plus"></i> Tambah Riwayat Pelatihan</a><br><br><br>
  ...
  <tbody>
    <?php 
      ...
      <td><?php echo ++$no;?></td>
        ...
        <td>
        <a href="<?php echo base_url(); ?>pegawai/hapus_pelatihan/<?php echo $data->id_pelatihan; ?>/<?php echo $pegawai->id_pegawai; ?>" class="btn btn-danger btn-xs btn-flat" onclick="return confirm(<?php echo $alert; ?>)"><i class="glyphicon glyphicon-trash"></i><span class="tooltiptext">Hapus</span></a>
      </td>
    </tr>
<?php endforeach; ?>
           ...
           <div class="modal fade" id="modal_tambah" >
            ...
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="myModalLabel">Tambah Riwayat Pelatihan</h3>
            </div>
            <?php echo form_open('pegawai/simpan_pelatihan/'.$pegawai->id_pegawai); ?>
            <div class="form-horizontal">
                <div class="modal-body">

                    <div class="form-group">
                        <label class="col-xs-4" >Nama Pelatihan<font color="#FF0000">*</font></label>
                        <div class="col-xs-6">
                            <input type="text" name="nama_pelatihan" class="form-control input-sm pull-left" id="nama_pelatihan" value="" required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-4" >Jenis Pelatihan </label>
                        <div class="col-xs-6">
                            <input type="text" name="jenis_pelatihan" class="form-control input-sm pull-left" id="jenis_pelatihan" placeholder="" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-4" >Lokasi </label>
                        <div class="col-xs-6">
                            <input type="text" name="lokasi_pelatihan" class="form-control input-sm pull-left" id="lokasi_pelatihan" placeholder="" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-4" >Tanggal Awal Pelatihan<font color="#FF0000">*</font></label>
                        <div class="col-xs-6">
                    ...
                    <div class="form-group">
                        <label class="col-xs-4" >Tanggal Akhir Pelatihan <font color="#FF0000">*</font></label>
                        <div class="col-xs-6">
