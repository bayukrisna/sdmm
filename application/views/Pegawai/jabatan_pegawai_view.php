       ...
       <a class="btn btn-sm btn-default btn-flat" href="<?php echo base_url(); ?>pegawai"><i class="fa fa-angle-left"></i> Back</a>
         ...
         <a class="btn btn-sm btn-warning btn-flat" href="<?php echo base_url();?>pegawai/jabatan/<?php echo $pegawai->id_pegawai; ?>">Jabatan</a>
...
<div class="box box-info">
  ...
  <tr>
    ...
    <th style="text-align:center">Tanggal SK Jabatan</th>
  ...
  <tbody>
    <?php 
      ...
      <td><?php echo ++$no;?></td>
        ...
        <td><?php echo $data->sk_jabatan;?></td>
        <td><?php if ($data->tgl_sk_jabatan == '0000-00-00') {
          $a = ''; } else {
            $a = date("d M Y", strtotime($data->tgl_sk_jabatan));
          }
         echo $a;?></td>
        <td>
        <a href="<?php echo base_url(); ?>pegawai/hapus_jabatan/<?php echo $data->id_jabatan; ?>/<?php echo $pegawai->id_pegawai; ?>" class="btn btn-danger btn-xs btn-flat" onclick="return confirm(<?php echo $alert; ?>)"><i class="glyphicon glyphicon-trash"></i><span class="tooltiptext">Hapus</span></a>
      </td>
    </tr>
<?php endforeach; ?>
           ...
           <div class="modal fade" id="modal_tambah" >
            ...
            <?php echo form_open('pegawai/simpan_jabatan/'.$pegawai->id_pegawai); ?>
            <div class="form-horizontal">
                <div class="modal-body">

                    <div class="form-group">
                        <label class="col-xs-4" >Nama Jabatan <font color="#FF0000">*</font></label>
                        <div class="col-xs-6">
                            <input type="text" name="nama_jabatan" class="form-control input-sm pull-left" id="nama_jabatan" value="" required="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-4" >SK Jabatan </label>
                        <div class="col-xs-6">
                            <input type="text" name="sk_jabatan" class="form-control input-sm pull-left" id="sk_jabatan" placeholder="" value="">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-xs-4" >Tanggal SK Jabatan</label>
                        <div class="col-xs-6">
                            <input type="date" name="tgl_sk_jabatan" class="form-control input-sm pull-left" id="tgl_sk_jabatan" placeholder="" value="">
                        </div>
                    </div>
