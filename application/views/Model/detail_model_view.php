      ...
      <?php echo $model->nama_model; ?>      </td>

      
        </tr>
        <tr>
          <td class="left_column">Total  </td>
            <td colspan="3">:  <?php $total_barang = $this->db->query("SELECT count(*) AS total FROM tb_barang JOIN tb_model ON tb_model.id_model=tb_barang.id_model JOIN tb_merk ON tb_merk.id_merk=tb_model.id_merk JOIN tb_kategori ON tb_kategori.id_kategori=tb_model.id_kategori WHERE tb_model.id_model = $model->id_model")->row(); ?>
...
<div class="">   
             ...
             <a class="btn btn-default btn-sm pull-right" style="margin-right: 10px"  href="<?php echo base_url('model'); ?>"><i class="fa fa-angle-left"></i> Back </a> <br> <br>
